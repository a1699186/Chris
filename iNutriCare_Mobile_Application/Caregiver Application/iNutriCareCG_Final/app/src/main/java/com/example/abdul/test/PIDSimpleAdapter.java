...
public class PIDSimpleAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private ArrayList<PatientSimple> patients;

    public PIDSimpleAdapter() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            view = layoutInflater.inflate(R.layout.pid_list_item, parent, false);
        ...
        viewHolder.textView2.setText(patients.get(position).pid+"");
