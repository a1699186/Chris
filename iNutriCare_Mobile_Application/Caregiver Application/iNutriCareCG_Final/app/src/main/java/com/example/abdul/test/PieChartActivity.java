...
public class PieChartActivity extends AppCompatActivity implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMeal=new String[CArray.size()];
        calories=new int[CArray.size()];
        ...
        for (Object consumption : CArray) {
            ...
            calories[i]=Integer.parseInt(obj.get("consumption").toString());
            if(obj.get("mealtype").toString().equals("BF"))
            {
                mMeal[i]="Breakfast";
            }
            else if(obj.get("mealtype").toString().equals("LN"))
            {
                mMeal[i]="Lunch";
            }
            else if(obj.get("mealtype").toString().equals("DN"))
            {
                mMeal[i]="Dinner";
            }
            else
    ...
    private void setData(int count, float range) {
        ...
        for (int i = 0; i < count + 1; i++) {
            yVals1.add(new Entry(calories[i],i));
        }
        ...
        PieDataSet dataSet = new PieDataSet(yVals1, "Meal Type");
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Meal Consumption\nBased on Meal Type");
        s.setSpan(new RelativeSizeSpan(1.7f), 0, 16, 0);
        s.setSpan(new StyleSpan(Typeface.NORMAL), 16, s.length() - 18, 0);
        s.setSpan(new ForegroundColorSpan(Color.BLACK), 16, s.length() - 18, 0);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PieChartActivity.this,LoadingScreenGraph.class);
